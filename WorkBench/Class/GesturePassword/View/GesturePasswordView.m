...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        state = [[UILabel alloc]initWithFrame:CGRectMake(frame.size.width/2-140, frame.size.width/2-25, 280, 30)];
        ...
        [imgView.layer setBorderColor:[UIColor colorWithRed:0 green:122/255.0 blue:255/255.0 alpha:1].CGColor];
        [imgView.layer setBorderWidth:3];
        [imgView setImage:[UIImage imageNamed:@"120.png"]];
        [self addSubview:imgView];
        
        forgetButton = [[UIButton alloc]initWithFrame:CGRectMake(frame.size.width/2-150, frame.size.height-35, 120, 30)];
        ...
        changeButton = [[UIButton alloc]initWithFrame:CGRectMake(frame.size.width/2+30, frame.size.height-35, 120, 30)];
...
- (void)drawRect:(CGRect)rect
{
    ...
    //[UIColor colorWithRed:0 green:122/255.0 blue:255/255.0 alpha:1]
    CGFloat colors[] =
    {
