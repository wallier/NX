...
@interface BNApartmentController ()<UIScrollViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
...
@implementation BNApartmentController
...
//        [_collectionView setBackgroundView:imgView];
        ...
        if (self.oneFloor_Houses<5 && self.oneFloor_Houses>1) {
            ...
            [_collectionView registerClass:[BNApartmentCollectionCell class] forCellWithReuseIdentifier:reuseIdentifier];
    ...
    if (_isFirstLoad) {
        ...
        cellNumLabel.frame=CGRectMake(SCREEN_W/2-25, 10, 50, 30);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.oneFloor_Houses<5 && self.oneFloor_Houses>1) {
        ...
        if (indexPath.row != self.unitDetailArray.count){
            ...
            BNApartmentCollectionCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
            if (!cell) {
                cell = [[[NSBundle mainBundle]loadNibNamed:@"BNApartmentCollectionCell" owner:nil options:nil]firstObject];
                return cell;
            }
            // 画实线框
