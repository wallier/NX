...
@implementation MTToViewTopButton {
    ...
    __weak UICollectionView *_scrollView;
}

- (instancetype)initWithFrame:(CGRect)frame scrollView:(UICollectionView *)scrollView{
...
- (void)scrollView:(UICollectionView *__unsafe_unretained)scrollView clickButtonActionHandler:(void (^)(UIButton *))touchHandler {
