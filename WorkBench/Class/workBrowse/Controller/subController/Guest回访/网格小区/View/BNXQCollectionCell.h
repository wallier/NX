...
@interface BNXQCollectionCell : UICollectionViewCell

@property (weak, nonatomic) IBOutlet UILabel *AllSelfWlan;
@property (weak, nonatomic) IBOutlet UILabel *AllSelfItv;
@property (weak, nonatomic) IBOutlet UILabel *otherWlan;
@property (weak, nonatomic) IBOutlet UILabel *otherItv;
