...
@interface BNWangGeViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
...
static int buttonY;
@implementation BNWangGeViewController
