...
@interface BNQuXianViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BNQuXianViewController
// 懒加载数组
...
- (NSString *)getUrl{
    if ([[LoginModel shareLoginModel].ORG_MANAGER_TYPE isEqualToString:@"QX"]) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BNHuaXiaoViewController *huaXiaoVC = [[BNHuaXiaoViewController alloc]init];
    huaXiaoVC.org_id= gridRoleModel.ID;
    huaXiaoVC.org_manger_type = gridRoleModel.ORG_MANAGER_TYPE;
    huaXiaoVC.name = gridRoleModel.NAME;
