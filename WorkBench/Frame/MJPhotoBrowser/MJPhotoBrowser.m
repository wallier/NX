...
{
//    [[UIApplication sharedApplication] setStatusBarHidden:_statusBarHiddenInited];
...
- (void)photoViewLongPress:(MJPhotoView *)photoView withPhoto:(MJPhoto *)photo
{
    _willSaveImage = photo.image;
    UIActionSheet *sheet = [[UIActionSheet alloc] initWithTitle:@"选择图片" delegate:self cancelButtonTitle:@"取消" destructiveButtonTitle:nil otherButtonTitles:@"保存图片", nil];
...
{
    UIImageWriteToSavedPhotosAlbum(_willSaveImage, self, @selector(image:didFinishSavingWithError:contextInfo:), NULL);
}
